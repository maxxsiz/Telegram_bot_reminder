...
def check_break_time(breaktime):
    match = re.fullmatch(r'[0-1][0-9][:][0-5][0,5]-[0-2][0-9][:][0-5][0,5]|[2][0-3][:][0-5][0,5]-[2][0-3][:][0-5][0,5]', breaktime)
    return True if match else False

def check_periodisity(periodisity): # min 5m, max 8h or 480m
    match = re.fullmatch(r'[1-8]h|5m|[1-9][5,0]m|[1-3][0-9][0,5]m|4[0-8]0m|4[0-7][0,5]m', periodisity)
    return True if match else False
